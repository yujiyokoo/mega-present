...
void mrbc_init(void)
{
  ...
  mrbc_define_method(0, static_class_object, "sleep",           c_sleep);
  mrbc_define_method(0, static_class_object, "sleep_ms",        c_sleep_ms);
  mrbc_define_method(0, static_class_object, "relinquish",      c_relinquish);
  mrbc_define_method(0, static_class_object, "change_priority", c_change_priority);
  mrbc_define_method(0, static_class_object, "suspend_task",    c_suspend_task);
  mrbc_define_method(0, static_class_object, "resume_task",     c_resume_task);
}
